...
//                netConnection.getPlayer().inventory.add(new TestCube(), 32);
                ...
                netConnection.getPlayer().inventory.add(new StoneStairBlockItem(), 32);
                netConnection.getPlayer().inventory.add(new StoneCornerBlockItem(), 32);
                netConnection.getPlayer().inventory.add(new StoneBattlementBlockItem(), 32);
                netConnection.getPlayer().inventory.add(new StoneBattlementCornerBlockItem(), 32);

...
import lowentry.ue4.libs.jackson.databind.jsonFormatVisitors.JsonStringFormatVisitor;
...
import lowentry.ue4.libs.jackson.databind.ser.BeanSerializer;
 ...
 * {@link lowentry.ue4.libs.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link lowentry.ue4.libs.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     *    
        ...
        throws JsonMappingException
    {
        ...
        return lowentry.ue4.libs.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }

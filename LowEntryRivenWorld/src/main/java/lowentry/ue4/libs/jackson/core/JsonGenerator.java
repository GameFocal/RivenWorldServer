...
import lowentry.ue4.libs.jackson.core.type.WritableTypeId.Inclusion;
import lowentry.ue4.libs.jackson.core.util.VersionUtil;

import static lowentry.ue4.libs.jackson.core.JsonTokenId.*;
    ...
    implements Closeable, Flushable, Versioned
{
    ...
    public enum Feature {
         ...
         *
         * @deprecated Since 2.10 use {@link lowentry.ue4.libs.jackson.core.json.JsonWriteFeature#QUOTE_FIELD_NAMES} instead
         */
        @Deprecated
         ...
         * Feature is enabled by default.
         *
         * @deprecated Since 2.10 use {@link lowentry.ue4.libs.jackson.core.json.JsonWriteFeature#WRITE_NAN_AS_STRINGS} instead
         */
         @Deprecated
         ...
         *
         * @deprecated Since 2.10 use {@link lowentry.ue4.libs.jackson.core.json.JsonWriteFeature#ESCAPE_NON_ASCII} instead
         */
        @Deprecated
         ...
         * Feature is disabled by default.
         *
         * @deprecated Since 2.10 use {@link lowentry.ue4.libs.jackson.core.json.JsonWriteFeature#WRITE_NUMBERS_AS_STRINGS} instead
         */
        @Deprecated
...
//        throw new IllegalArgumentException("No FormatFeatures defined for generator of type "+getClass().getName());
     ...
     * ({@link lowentry.ue4.libs.jackson.core.util.DefaultPrettyPrinter}).
     *
     * @return Generator itself (this), to allow chaining
     */

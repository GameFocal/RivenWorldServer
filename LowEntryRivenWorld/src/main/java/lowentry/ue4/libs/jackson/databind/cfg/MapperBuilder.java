...
import lowentry.ue4.libs.jackson.annotation.JsonAutoDetect;
import lowentry.ue4.libs.jackson.annotation.JsonInclude;
import lowentry.ue4.libs.jackson.annotation.JsonSetter;
import lowentry.ue4.libs.jackson.annotation.JsonTypeInfo;
import lowentry.ue4.libs.jackson.annotation.PropertyAccessor;
import lowentry.ue4.libs.jackson.core.*;
import lowentry.ue4.libs.jackson.databind.*;
import lowentry.ue4.libs.jackson.databind.ObjectMapper.DefaultTyping;
import lowentry.ue4.libs.jackson.databind.deser.*;
import lowentry.ue4.libs.jackson.databind.introspect.VisibilityChecker;
import lowentry.ue4.libs.jackson.databind.jsontype.NamedType;
import lowentry.ue4.libs.jackson.databind.jsontype.PolymorphicTypeValidator;
import lowentry.ue4.libs.jackson.databind.jsontype.SubtypeResolver;
import lowentry.ue4.libs.jackson.databind.node.JsonNodeFactory;
import lowentry.ue4.libs.jackson.databind.ser.*;
    ...
    B extends MapperBuilder<M,B>>
{
    ...
    public B addModule(lowentry.ue4.libs.jackson.databind.Module module)
    {
        _mapper.registerModule(module);
        return _this();
    }

    public B addModules(lowentry.ue4.libs.jackson.databind.Module... modules)
    {
        for (lowentry.ue4.libs.jackson.databind.Module module : modules) {
            addModule(module);
        }
        return _this();
    }

    public B addModules(Iterable<? extends lowentry.ue4.libs.jackson.databind.Module> modules)
    {
        for (lowentry.ue4.libs.jackson.databind.Module module : modules) {
            addModule(module);
        }
     ...
     */
    public static List<lowentry.ue4.libs.jackson.databind.Module> findModules() {
     ...
     * potentially expensive.
     */
    public static List<lowentry.ue4.libs.jackson.databind.Module> findModules(ClassLoader classLoader)
    {
        ArrayList<lowentry.ue4.libs.jackson.databind.Module> modules = new ArrayList<>();
        ServiceLoader<lowentry.ue4.libs.jackson.databind.Module> loader = secureGetServiceLoader(lowentry.ue4.libs.jackson.databind.Module.class, classLoader);
        for (lowentry.ue4.libs.jackson.databind.Module module : loader) {
            modules.add(module);
        }
        return modules;
    }

...
public enum SerializationFeature implements ConfigFeature
{
     ...
     * no explicit {@link lowentry.ue4.libs.jackson.core.PrettyPrinter} has been configured
     ...
     * in conjunction with {@link lowentry.ue4.libs.jackson.annotation.JsonUnwrapped}.
     ...
     *   using {@link lowentry.ue4.libs.jackson.annotation.JsonInclude} or configuration overrides
     ...
     * {@link lowentry.ue4.libs.jackson.core.JsonGenerator#writeNumber(String)}
     * it may cause compatibility problems since not all {@link lowentry.ue4.libs.jackson.core.JsonGenerator}
     * implementations support such mode of output: usually only text-based formats
     * support it.
     *<p>
     * Feature is disabled by default.
     * 
     * @deprecated Since 2.5: use {@link lowentry.ue4.libs.jackson.core.JsonGenerator.Feature#WRITE_BIGDECIMAL_AS_PLAIN} instead
     *    (using {@link ObjectWriter#with(lowentry.ue4.libs.jackson.core.JsonGenerator.Feature)}).
     */

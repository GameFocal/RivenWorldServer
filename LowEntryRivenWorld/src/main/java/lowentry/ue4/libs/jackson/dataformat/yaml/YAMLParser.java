...
import lowentry.ue4.libs.snakeyaml.events.*;
...
import lowentry.ue4.libs.jackson.core.base.ParserBase;
...
//    @Override public CsvSchema getSchema() 
    ...
    public JsonToken nextToken() throws IOException
    {
        ...
        while (true) {
            ...
            } catch (lowentry.ue4.libs.snakeyaml.error.YAMLException e) {
                if (e instanceof lowentry.ue4.libs.snakeyaml.error.MarkedYAMLException) {
                    throw lowentry.ue4.libs.jackson.dataformat.yaml.snakeyaml.error.MarkedYAMLException.from
                        (this, (lowentry.ue4.libs.snakeyaml.error.MarkedYAMLException) e);
                }

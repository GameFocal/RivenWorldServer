...
import lowentry.ue4.libs.jackson.databind.cfg.ConfigFeature;
...
public enum DeserializationFeature implements ConfigFeature
{
     ...
     * {@link lowentry.ue4.libs.jackson.databind.node.JsonNodeFactory} has
     * {@link lowentry.ue4.libs.jackson.databind.node.JsonNodeFactory#withExactBigDecimals} for
     ...
     * value (indicated for example by {@link lowentry.ue4.libs.jackson.annotation.JsonTypeInfo})
     ...
     * ({@link lowentry.ue4.libs.jackson.core.TreeNode}) and a duplicate key
     ...
     * {@link lowentry.ue4.libs.jackson.annotation.JsonTypeInfo.As#EXTERNAL_PROPERTY} is missing,
     ...
     * {@link lowentry.ue4.libs.jackson.core.JsonParser#nextToken} is made to ensure that
     * no more tokens are found (and if any is found,
     * {@link lowentry.ue4.libs.jackson.databind.exc.MismatchedInputException} is thrown); if
     ...
     * {@link lowentry.ue4.libs.jackson.annotation.JsonEnumDefaultValue @JsonEnumDefaultValue} annotation.
     * If disabled, unknown Enum values will throw exceptions.

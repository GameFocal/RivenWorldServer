...
import lowentry.ue4.libs.jackson.databind.ser.impl.SimpleBeanPropertyFilter;
 ...
 * to find filter to used based on id specified by {@link lowentry.ue4.libs.jackson.annotation.JsonFilter}

...
import lowentry.ue4.libs.jackson.databind.annotation.JsonSerialize;
import lowentry.ue4.libs.jackson.databind.cfg.SerializerFactoryConfig;
...
import lowentry.ue4.libs.jackson.databind.ser.impl.*;
import lowentry.ue4.libs.jackson.databind.ser.std.*;
    ...
    implements java.io.Serializable
{
     ...
     *  </li>
     * <li>If type has {@link lowentry.ue4.libs.jackson.annotation.JsonValue} annotation (or equivalent), build serializer
     ...
     * has an annotation
     * (@link lowentry.ue4.libs.jackson.databind.annotation.JsonSerialize#using)

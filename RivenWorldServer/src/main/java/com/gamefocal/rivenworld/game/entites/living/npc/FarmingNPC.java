...
public class FarmingNPC extends ShopNPC<FarmingNPC> {

    public FarmingNPC() {
//        this.equipmentSlots.head = new InventoryStack(new ClothCap(), 1);
        this.equipmentSlots.chest = new InventoryStack(new SimpleClothLegs(), 1);
    ...
    public void onInteract(HiveNetConnection connection, InteractAction action, InventoryStack inHand) {
        Shop shop = DedicatedServer.get(ShopService.class).getShop(GameShop.FARMING);

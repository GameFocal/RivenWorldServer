...
public class SandLayer implements WorldLayerGenerator {
    @Override
...
//        cellularGenerator.generate(grid);
        ...
        for (int x = 0; x < grid.getWidth(); x++) {
            for (int y = 0; y < grid.getHeight(); y++) {
                ...
                if (cell > .50 && height >= 3500 && height <= 4200 && RandomUtil.getRandomChance(.01)) {
                    ...
                    resourceNode.spawnEntity = new SandNode();

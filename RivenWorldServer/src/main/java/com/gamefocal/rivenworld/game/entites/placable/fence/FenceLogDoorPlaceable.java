...
public class FenceLogDoorPlaceable extends DoorEntity<FenceLogDoorPlaceable> implements CollisionEntity {

    public FenceLogDoorPlaceable() {
        this.type = "Fence_logDoor";

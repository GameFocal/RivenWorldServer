...
public class DefenciveSpikedFencePlaceable extends PlaceableEntity<DefenciveSpikedFencePlaceable> implements CollisionEntity {

    public DefenciveSpikedFencePlaceable() {
        this.type = "DefenciveSpikedFencePlaceable";
        this.health = 800;
        this.maxHealth = 800;

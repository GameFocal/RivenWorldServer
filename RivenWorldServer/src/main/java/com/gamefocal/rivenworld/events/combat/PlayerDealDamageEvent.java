...
public class PlayerDealDamageEvent extends Event<PlayerDealDamageEvent> {
    ...
    public PlayerDealDamageEvent(HiveNetConnection player, float damage, HitResult hitResult, HitDamage hitDamage) {
        this.player = player;
        this.damage = damage;

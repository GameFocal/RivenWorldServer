...
@Command(name = "deop", sources = "chat,cli")
public class DeOpCommand extends HiveCommand {
    @Override
    public void onCommand(HiveNetMessage message, CommandSource source, HiveNetConnection netConnection) throws Exception {
        ...
        if (connection != null) {
            DedicatedServer.admins.remove(connection.getHiveId());
            return;
        }

        DedicatedServer.admins.remove(id);
    }
}

...
public class MappingNode extends CollectionNode<NodeTuple> {
     ...
     * @deprecated Since restored in v1.22.  Use {@link MappingNode#MappingNode(Tag, boolean, List, Mark, Mark, lowentry.ue4.libs.snakeyaml.DumperOptions.FlowStyle) }.
     */
    @Deprecated
    public MappingNode(Tag tag, boolean resolved, List<NodeTuple> value, Mark startMark,
     ...
     * Existed in older versions but replaced with {@link DumperOptions.FlowStyle}-based constructor.
     * Restored in v1.22 for backwards compatibility.
     * @deprecated Since restored in v1.22.  Use {@link MappingNode#MappingNode(Tag, List, lowentry.ue4.libs.snakeyaml.DumperOptions.FlowStyle) }.
     */
    @Deprecated

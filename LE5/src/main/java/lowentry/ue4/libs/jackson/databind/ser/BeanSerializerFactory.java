...
import lowentry.ue4.libs.jackson.databind.ser.impl.FilteredBeanPropertyWriter;
import lowentry.ue4.libs.jackson.databind.ser.impl.ObjectIdWriter;
import lowentry.ue4.libs.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator;
import lowentry.ue4.libs.jackson.databind.ser.std.MapSerializer;
import lowentry.ue4.libs.jackson.databind.ser.std.StdDelegatingSerializer;
...
//            throw new IllegalArgumentException("Cannot create bean serializer for Object.class");
     ...
     * by default this is based on {@link lowentry.ue4.libs.jackson.annotation.JsonIgnoreType}

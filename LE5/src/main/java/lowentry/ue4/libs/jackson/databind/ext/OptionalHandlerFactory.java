...
public class OptionalHandlerFactory implements java.io.Serializable
{
    ...
    private final static String SERIALIZERS_FOR_JAVAX_XML = "lowentry.ue4.libs.jackson.databind.ext.CoreXMLSerializers";
    private final static String DESERIALIZERS_FOR_JAVAX_XML = "lowentry.ue4.libs.jackson.databind.ext.CoreXMLDeserializers";
...
//    private final static String CLASS_NAME_DOM_DOCUMENT = "org.w3c.dom.Document";
    private final static String SERIALIZER_FOR_DOM_NODE = "lowentry.ue4.libs.jackson.databind.ext.DOMSerializer";
    private final static String DESERIALIZER_FOR_DOM_DOCUMENT = "lowentry.ue4.libs.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
    private final static String DESERIALIZER_FOR_DOM_NODE = "lowentry.ue4.libs.jackson.databind.ext.DOMDeserializer$NodeDeserializer";

 ...
 * but instead extend {@link lowentry.ue4.libs.jackson.databind.deser.std.StdDeserializer}
 * (or its subtypes like {@link lowentry.ue4.libs.jackson.databind.deser.std.StdScalarDeserializer}).
 *<p>
    ...
    implements NullValueProvider // since 2.9
{
     ...
     * annotation {@link lowentry.ue4.libs.jackson.databind.annotation.JsonDeserialize}
     */
@SuppressWarnings("all")

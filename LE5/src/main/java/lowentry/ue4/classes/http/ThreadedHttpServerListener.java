...
public interface ThreadedHttpServerListener
{
	 ...
	 */
	void clientConnected(final ThreadedHttpServer threadedServer, final HttpServer server, final HttpClient client);
	 ...
	 */
	void clientDisconnected(final ThreadedHttpServer threadedServer, final HttpServer server, final HttpClient client);
	
	/**
	 * This function is called when you have received a request.
	 */
	void receivedRequest(final ThreadedHttpServer threadedServer, final HttpServer server, final HttpClient client, final HttpRequest request, final HttpResponse response);
}

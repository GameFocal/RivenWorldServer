...
public class SocketServerClientHandler implements PyroClientListener
{
	...
	public DatagramPacket getUdpOutPacket() {
		return udpOutPacket;
	}

	public void setUdpOutPacket(DatagramPacket udpOutPacket) {
		this.udpOutPacket = udpOutPacket;
	}
				...
				{// get client UDP port >>
					if(!hasReceivedClientUdpPort)
					{
						...
						else
						{
							...
							socketClient.setRemoteUdpPort(receivedInt); // TODO: ZP, Client Set UDP PORT HERE
						}
						
						socketServer.addUdpClient(this); // TODO: This is how you add a client.
					}
				}// get client UDP port <<
